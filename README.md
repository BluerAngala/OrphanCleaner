...
从 [Releases](https://github.com/BluerAngala/OrphanCleaner/releases) 页面下载最新版 `仿win自动清理工具.dmg`。
...
# 3. 运行
open Build/仿win自动清理工具.app

# 或复制到 Applications
cp -r Build/仿win自动清理工具.app ~/Applications/
```
